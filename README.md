<div align="center">
  ...
  <p><strong>A comprehensive, production-ready guide to automating your CI/CD workflows and integrating Security (SAST) checks.</strong></p>
...
### How to Run Locally
If you wish to replicate the local scan via Podman instead of the cloud, run:
```powershell
...
2. **`02-sonarcloud-scan.yml`**: SonarCloud SAST Static Code Analysis Integration.
...
---
*Created as a comprehensive, working demo for demonstrating GitHub Actions and SonarQube capabilities.*
